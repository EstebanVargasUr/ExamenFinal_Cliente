package org.una.examenfinalcliente.utility;

import org.una.examenfinalcliente.App;
import org.una.examenfinalcliente.controllersView.Controller;
...
public class FlowController {
    ...
    private FXMLLoader getLoader(String name) {
        ...
        if (loader == null) {
            synchronized (FlowController.class) {
                if (loader == null) {
                    try {
                        loader = new FXMLLoader(App.class.getResource("/org/una/examenfinalcliente/view/" + name + ".fxml"), this.idioma);
                        loader.load();
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("/org/una/examenfinalcliente/view/Principal.fxml"), this.idioma)));
            this.mainStage.show();
